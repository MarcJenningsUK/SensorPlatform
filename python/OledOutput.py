...
temp = "1"
humid = "2"
imageFile = "branding.png"
ipAddress = "3"
copyrightText1 = "©2017 Marc"
copyrightText2 = "Jennings"
...
def Display():
	...
	global ipAddress
	global imageFile
	global copyrightText1
	global copyrightText2
	...
	# display ip address
		...
		draw.rectangle((0,0,width,height), outline=0, fill=0)
		draw.text((0, 0), "current IP", font=font, fill=255)
		draw.text((0, 32), ipAddress, font=font, fill=255)
		disp.image(image)
	
	# display branding image
	elif(displayMode == 4):
		brandimage = Image.open(imageFile).convert('1')
		draw.rectangle((0,0,width,height), outline=0, fill=0)
	...
	# display copyright notice
		...
		draw.rectangle((0,0,width,height), outline=0, fill=0)
		draw.text((0, 0), copyrightText1, font=font, fill=255)
		draw.text((0, 32), copyrightText2, font=font, fill=255)
		disp.image(image)
